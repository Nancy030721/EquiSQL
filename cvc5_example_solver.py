...
#   x = tm.mkConst(realSort, "x")
#   solver.assertFormula(tm.mkTerm(Kind.EQUAL, tm.mkInteger(0), tm.mkTerm(Kind.ADD, x, tm.mkInteger(0))))
...
q1 = s.mkConst(s.getBooleanSort(), "q1")
q2 = s.mkConst(s.getBooleanSort(), "q2")

# force both to false
s.assertFormula(tm.mkTerm(Kind.EQUAL, q1, tm.mkFalse()))
s.assertFormula(tm.mkTerm(Kind.EQUAL, q2, tm.mkFalse()))

# assert they differ
s.assertFormula(tm.mkTerm(Kind.NOT, tm.mkTerm(Kind.EQUAL, q1, q2)))

result = s.checkSat()
print("checkSat:", result)
if result.isSat():
  print("model:")
  print(s.getModel([], [q1, q2]).decode("utf-8"))
